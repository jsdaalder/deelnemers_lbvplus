...
- `analysis/` – lightweight scripts to turn the processed tables into charts and a trimmed CSV for sharing.
...
3) **Charts & export**: from repo root run `python3 analysis/ftm/14_generate_charts.py` and then `python3 analysis/ftm/13_export_final_results.py` to write `final_results/<date>/chart_all_<date>.png` and a slim CSV.
